        ...
        <div class="">
            <div class="row ">
                <div class="col-lg-7 col-md-6 position-relative">
                    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="90%" viewBox="0 0 888 741.04834" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <path d="M952.85457,757.07471l-68.32479-48.32553c23.04357-22.44766,44.00226-54.41107,64.04589-90.55092l68.32478,48.32553C989.59882,697.53027,966.4714,727.95969,952.85457,757.07471Z" transform="translate(-156 -79.47583)" fill="#6c63ff" />
                        ...
                        <path d="M820.546,756.99571H736.85827c5.85094-31.63336,4.50486-69.83172,0-110.91142H820.546C816.161,687.16411,814.85062,725.36241,820.546,756.99571Z" transform="translate(-156 -79.47583)" fill="#6c63ff" />
                    ...
                    <div class="position-absolute" style="top: 20%; left: 50%; transform: translate(-50%, -50%);">
                        <h5 class="card-title text-center pb-0 fs-4" style="font-size: 40px !important ;">Open UMKM</h5>
                        <p class="text-center small">Tempatnya UMKM Masohi Berkumpul</p>
                    </div>
                </div>
                <div class="col-lg-5 col-md-6 d-flex flex-column align-items-center justify-content-center">
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="pt-4 pb-2">
                                <h5 class="card-title text-center pb-0 fs-4">Masuk ke Dashboard</h5>
                                <p class="text-center small">Masukkan e-mail & password untuk masuk</p>
                            </div>
                            ...
                            @endif
                            <form class="row g-3 needs-validation " novalidat wire:submit.prevent="save">
                                <div class="col-12">
                                    <label for="yourUsername" class="form-label">E-mail</label>
                                    <div class="input-group has-validation">
                                        <input wire:model="email" type="text" name="username" class="form-control  @error('email') is-invalid @enderror" id="yourUsername">
                                        @error('email')
                                ...
                                <div class="col-12">
                                    ...
                                    <input wire:model="password" type="password" name="password" class="form-control @error('password') is-invalid @enderror" id="yourPassword">
                                    @error('password')
                                    <div class="invalid-feedback">{{$message}}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12">
                                    <p class="small mb-0">Belum punya akun? <a href="/register">Daftar UMKM</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
